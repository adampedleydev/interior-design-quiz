<?php
session_start();
$_SESSION['bedroom2_starting_scratch'] = $_GET["starting_scratch"];
$_SESSION['bedroom2_part_way'] =  $_GET["part_way"];
$_SESSION['bedroom2_mostly_furnished'] =  $_GET["mostly_furnished"];
