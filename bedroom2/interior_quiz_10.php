...
$_SESSION['bedroom2_eclectic'] = $_GET["eclectic"];
$_SESSION['bedroom2_bohemian'] = $_GET["bohemian"];
$_SESSION['bedroom2_contemporary'] = $_GET["contemporary"];
$_SESSION['bedroom2_coastal'] = $_GET["coastal"];
$_SESSION['bedroom2_dramatic_bold'] = $_GET["dramatic_bold"];
$_SESSION['bedroom2_glam'] = $_GET["glam"];
$_SESSION['bedroom2_industrial'] = $_GET["industrial"];
$_SESSION['bedroom2_rustic'] = $_GET["rustic"];
$_SESSION['bedroom2_scandi'] = $_GET["scandi"];
$_SESSION['bedroom2_traditional'] = $_GET["traditional"];
$_SESSION['bedroom2_transitional'] = $_GET["transitional"];
...
<html lang="en">
      ...
      <div class="type-sticker">
        <div class="quiz-circle-3 hvr-grow">
          <span>
            ...
            <div class="circle-label">Bedroom #2</div>
          </span>
        </div>
      </div>
        ...
        <div class="center-grid">
          <textarea id="bedroom2add" style="border: 2px solid #f6936e; width: 40%; resize: none; margin-top: 40px;"></textarea>
        </div>
        <div class="quiz-next">
    ...
    <script>
      ...
      function nextPage(){
        var text = document.getElementById("bedroom2add").value;
        var encode = btoa(text)
        if (arr.length > 0) {
          window.location.href="../"+nextSection+"/interior_quiz_intro.php?bedroom2_add=" + encode + "";
        } else {
          window.location.href="../interior_quiz_11.php?bedroom2_add=" + encode + "";
        }
      }
