...
$_SESSION['bedroom3_eclectic'] = $_GET["eclectic"];
$_SESSION['bedroom3_bohemian'] = $_GET["bohemian"];
$_SESSION['bedroom3_contemporary'] = $_GET["contemporary"];
$_SESSION['bedroom3_coastal'] = $_GET["coastal"];
$_SESSION['bedroom3_dramatic_bold'] = $_GET["dramatic_bold"];
$_SESSION['bedroom3_glam'] = $_GET["glam"];
$_SESSION['bedroom3_industrial'] = $_GET["industrial"];
$_SESSION['bedroom3_rustic'] = $_GET["rustic"];
$_SESSION['bedroom3_scandi'] = $_GET["scandi"];
$_SESSION['bedroom3_traditional'] = $_GET["traditional"];
$_SESSION['bedroom3_transitional'] = $_GET["transitional"];
...
<html lang="en">
    ...
    <body>
      <div class="type-sticker">
        ...
        <div class="center-grid">
          <textarea id="bedroom3add" style="border: 2px solid #f6936e; width: 40%; resize: none; margin-top: 40px;"></textarea>
        </div>
        <div class="quiz-next">
    ...
    <script>
      ...
      function nextPage(){
        var text = document.getElementById("bedroom3add").value;
        var encode = btoa(text)
        if (arr.length > 0) {
          window.location.href="../"+nextSection+"/interior_quiz_intro.php?bedroom3_add=" + encode + "";
        } else {
          window.location.href="../interior_quiz_11.php?bedroom3_add=" + encode + "";
        }
      }
