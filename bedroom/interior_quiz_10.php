...
$_SESSION['bedroom_eclectic'] = $_GET["eclectic"];
$_SESSION['bedroom_bohemian'] = $_GET["bohemian"];
$_SESSION['bedroom_contemporary'] = $_GET["contemporary"];
$_SESSION['bedroom_coastal'] = $_GET["coastal"];
$_SESSION['bedroom_dramatic_bold'] = $_GET["dramatic_bold"];
$_SESSION['bedroom_glam'] = $_GET["glam"];
$_SESSION['bedroom_industrial'] = $_GET["industrial"];
$_SESSION['bedroom_rustic'] = $_GET["rustic"];
$_SESSION['bedroom_scandi'] = $_GET["scandi"];
$_SESSION['bedroom_traditional'] = $_GET["traditional"];
$_SESSION['bedroom_transitional'] = $_GET["transitional"];
...
<html lang="en">
      ...
      <div class="type-sticker">
        <div class="quiz-circle-3 hvr-grow">
          <span>
            ...
            <div class="circle-label">Bedroom</div>
          </span>
        </div>
      </div>
        ...
        <div class="center-grid">
          <textarea id="bedroomadd" style="border: 2px solid #f6936e; width: 40%; resize: none; margin-top: 40px;"></textarea>
        </div>
        <div class="quiz-next">
    ...
    <script>
      ...
      function nextPage(){
        var text = document.getElementById("bedroomadd").value;
        var encode = btoa(text)
        if (arr.length > 0) {
          window.location.href="../"+nextSection+"/interior_quiz_intro.php?bedroom_add=" + encode + "";
        } else {
          window.location.href="../interior_quiz_11.php?bedroom_add=" + encode + "";
        }
      }
