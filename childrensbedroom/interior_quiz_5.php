<?php
session_start();
$_SESSION['childrensbedroom_starting_scratch'] = $_GET["starting_scratch"];
$_SESSION['childrensbedroom_part_way'] =  $_GET["part_way"];
$_SESSION['childrensbedroom_mostly_furnished'] =  $_GET["mostly_furnished"];
