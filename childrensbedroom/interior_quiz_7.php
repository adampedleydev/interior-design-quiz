...
$_SESSION['childrensbedroom_neutral'] =  $_GET["neutral"];
$_SESSION['childrensbedroom_neutralpops'] =  $_GET["neutralpops"];
$_SESSION['childrensbedroom_brightbold'] =  $_GET["brightbold"];
?>
<!DOCTYPE html>
<html lang="en">
    <head>
