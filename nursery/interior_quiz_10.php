...
$_SESSION['nursery_eclectic'] = $_GET["eclectic"];
$_SESSION['nursery_bohemian'] = $_GET["bohemian"];
$_SESSION['nursery_contemporary'] = $_GET["contemporary"];
$_SESSION['nursery_coastal'] = $_GET["coastal"];
$_SESSION['nursery_dramatic_bold'] = $_GET["dramatic_bold"];
$_SESSION['nursery_glam'] = $_GET["glam"];
$_SESSION['nursery_industrial'] = $_GET["industrial"];
$_SESSION['nursery_rustic'] = $_GET["rustic"];
$_SESSION['nursery_scandi'] = $_GET["scandi"];
$_SESSION['nursery_traditional'] = $_GET["traditional"];
$_SESSION['nursery_transitional'] = $_GET["transitional"];
...
<html lang="en">
    ...
    <body>
      <div class="type-sticker">
        ...
        <div class="center-grid">
          <textarea id="nurseryadd" style="border: 2px solid #f6936e; width: 40%; resize: none; margin-top: 40px;"></textarea>
        </div>
        <div class="quiz-next">
    ...
    <script>
      ...
      function nextPage(){
        var text = document.getElementById("nurseryadd").value;
        var encode = btoa(text)
        if (arr.length > 0) {
          window.location.href="../"+nextSection+"/interior_quiz_intro.php?nursery_add=" + encode + "";
        } else {
          window.location.href="../interior_quiz_11.php?nursery_add=" + encode + "";
        }
      }
