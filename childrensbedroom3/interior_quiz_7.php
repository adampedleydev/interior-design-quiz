...
$_SESSION['childrensbedroom3_neutral'] =  $_GET["neutral"];
$_SESSION['childrensbedroom3_neutralpops'] =  $_GET["neutralpops"];
$_SESSION['childrensbedroom3_brightbold'] =  $_GET["brightbold"];
?>
<!DOCTYPE html>
<html lang="en">
    <head>
        ...
        <div class="center-grid">
            <div style="padding-top: 65px;">
                <div style="padding-top: 15px;">
                  <h3 class="quiz-headers" style="width: 100%; text-align: center; padding-top: 25px;">Do you have any colours you would like to see in the space?</h3>
                </div>
            </div>
        </div>
        <div class="center-grid">
          <textarea id="colourtext" style="border: 2px solid #42de83b1; width: 40%; resize: none; margin-top: 40px;"></textarea>
        </div>
        <div class="quiz-next">
          <a href="interior_quiz_6.php">
    ...
    function nextPage(){
      ...
      window.location.href='./interior_quiz_8.php?val=' + encode + '';
    }
  </script>
</html>