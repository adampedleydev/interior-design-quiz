<?php
session_start();
$_SESSION['childrensbedroom3_starting_scratch'] = $_GET["starting_scratch"];
$_SESSION['childrensbedroom3_part_way'] =  $_GET["part_way"];
$_SESSION['childrensbedroom3_mostly_furnished'] =  $_GET["mostly_furnished"];
