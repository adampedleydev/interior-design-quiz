<?php
session_start();
$_SESSION['bedroom4_starting_scratch'] = $_GET["starting_scratch"];
$_SESSION['bedroom4_part_way'] =  $_GET["part_way"];
$_SESSION['bedroom4_mostly_furnished'] =  $_GET["mostly_furnished"];
