...
$_SESSION['livingroom_eclectic'] = $_GET["eclectic"];
$_SESSION['livingroom_bohemian'] = $_GET["bohemian"];
$_SESSION['livingroom_contemporary'] = $_GET["contemporary"];
$_SESSION['livingroom_coastal'] = $_GET["coastal"];
$_SESSION['livingroom_dramatic_bold'] = $_GET["dramatic_bold"];
$_SESSION['livingroom_glam'] = $_GET["glam"];
$_SESSION['livingroom_industrial'] = $_GET["industrial"];
$_SESSION['livingroom_rustic'] = $_GET["rustic"];
$_SESSION['livingroom_scandi'] = $_GET["scandi"];
$_SESSION['livingroom_traditional'] = $_GET["traditional"];
$_SESSION['livingroom_transitional'] = $_GET["transitional"];
...
<html lang="en">
    ...
    <body>
      <div class="type-sticker">
        ...
        <div class="center-grid">
          <textarea id="livingroomadd" style="border: 2px solid #f6936e; width: 40%; resize: none; margin-top: 40px;"></textarea>
        </div>
        <div class="quiz-next">
    ...
    <script>
      ...
      function nextPage(){
        var text = document.getElementById("livingroomadd").value;
        var encode = btoa(text)
        if (arr.length > 0) {
          window.location.href="../"+nextSection+"/interior_quiz_intro.php?livingroom_add=" + encode + "";
        } else {
          window.location.href="../interior_quiz_11.php?livingroom_add=" + encode + "";
        }
      }
