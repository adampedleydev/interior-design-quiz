<?php
session_start();
$_SESSION['livingroom_starting_scratch'] = $_GET["starting_scratch"];
$_SESSION['livingroom_part_way'] =  $_GET["part_way"];
$_SESSION['livingroom_mostly_furnished'] =  $_GET["mostly_furnished"];
