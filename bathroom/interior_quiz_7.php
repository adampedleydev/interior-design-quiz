...
$_SESSION['bath_neutral'] =  $_GET["neutral"];
$_SESSION['bath_neutralpops'] =  $_GET["neutralpops"];
$_SESSION['bath_brightbold'] =  $_GET["brightbold"];
?>
<!DOCTYPE html>
<html lang="en">
    <head>
      ...
      <div class="type-sticker">
        <div class="quiz-circle-3 hvr-grow">
          <span>
            ...
            <div class="circle-label">Bathroom</div>
          </span>
        </div>
      </div>
