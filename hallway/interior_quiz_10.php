...
$_SESSION['hallway_eclectic'] = $_GET["eclectic"];
$_SESSION['hallway_bohemian'] = $_GET["bohemian"];
$_SESSION['hallway_contemporary'] = $_GET["contemporary"];
$_SESSION['hallway_coastal'] = $_GET["coastal"];
$_SESSION['hallway_dramatic_bold'] = $_GET["dramatic_bold"];
$_SESSION['hallway_glam'] = $_GET["glam"];
$_SESSION['hallway_industrial'] = $_GET["industrial"];
$_SESSION['hallway_rustic'] = $_GET["rustic"];
$_SESSION['hallway_scandi'] = $_GET["scandi"];
$_SESSION['hallway_traditional'] = $_GET["traditional"];
$_SESSION['hallway_transitional'] = $_GET["transitional"];
...
<html lang="en">
    ...
    <body>
      <div class="type-sticker">
        ...
        <div class="center-grid">
          <textarea id="hallwayadd" style="border: 2px solid #f6936e; width: 40%; resize: none; margin-top: 40px;"></textarea>
        </div>
        <div class="quiz-next">
    ...
    <script>
      ...
      function nextPage(){
        var text = document.getElementById("hallwayadd").value;
        var encode = btoa(text)
        if (arr.length > 0) {
          window.location.href="../"+nextSection+"/interior_quiz_intro.php?hallway_add=" + encode + "";
        } else {
          window.location.href="../interior_quiz_11.php?hallway_add=" + encode + "";
        }
      }
