<?php
session_start();
$_SESSION['diningroom_starting_scratch'] = $_GET["starting_scratch"];
$_SESSION['diningroom_part_way'] =  $_GET["part_way"];
$_SESSION['diningroom_mostly_furnished'] =  $_GET["mostly_furnished"];
