...
$_SESSION['diningroom_eclectic'] = $_GET["eclectic"];
$_SESSION['diningroom_bohemian'] = $_GET["bohemian"];
$_SESSION['diningroom_contemporary'] = $_GET["contemporary"];
$_SESSION['diningroom_coastal'] = $_GET["coastal"];
$_SESSION['diningroom_dramatic_bold'] = $_GET["dramatic_bold"];
$_SESSION['diningroom_glam'] = $_GET["glam"];
$_SESSION['diningroom_industrial'] = $_GET["industrial"];
$_SESSION['diningroom_rustic'] = $_GET["rustic"];
$_SESSION['diningroom_scandi'] = $_GET["scandi"];
$_SESSION['diningroom_traditional'] = $_GET["traditional"];
$_SESSION['diningroom_transitional'] = $_GET["transitional"];
...
<html lang="en">
    ...
    <body>
      <div class="type-sticker">
        <div class="quiz-circle-3 hvr-grow">
          <span>
            <img src="../img/icons/dining-room.svg" class="circle-icon"></br>
        ...
        <div class="center-grid">
          <textarea id="diningroomadd" style="border: 2px solid #f6936e; width: 40%; resize: none; margin-top: 40px;"></textarea>
        </div>
        <div class="quiz-next">
    ...
    <script>
      ...
      function nextPage(){
        var text = document.getElementById("diningroomadd").value;
        var encode = btoa(text)
        if (arr.length > 0) {
          window.location.href="../"+nextSection+"/interior_quiz_intro.php?diningroom_add=" + encode + "";
        } else {
          window.location.href="../interior_quiz_11.php?diningroom_add=" + encode + "";
        }
      }
