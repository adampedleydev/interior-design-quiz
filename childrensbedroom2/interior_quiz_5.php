<?php
session_start();
$_SESSION['childrensbedroom2_starting_scratch'] = $_GET["starting_scratch"];
$_SESSION['childrensbedroom2_part_way'] =  $_GET["part_way"];
$_SESSION['childrensbedroom2_mostly_furnished'] =  $_GET["mostly_furnished"];
            ...
            <div class="center-grid">
              ...
              <div class="quiz-circle-1" style="margin-left: 70px; padding-top: 21px;">
                <span>
                  ...
                  <input type="radio" id="v20005000" clas s="hiddenCheck" name="opt"> 
                </span>
              </div>
              <div class="quiz-circle-1" style="margin-left: 70px; padding-top: 21px;">
                <span>
